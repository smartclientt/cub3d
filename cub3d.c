...
/*   Updated: 2023/01/28 08:33:11 by shbi             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	dda_algo(t_data *data)
{
	...
	raycasting(data);
	mlx_destroy_image(data->mlx, data->img2);// use it when i will use img to draw
	return (0);
}
...
{
	data->img_text1 = mlx_xpm_file_to_image(data->mlx, "./texture/text1.xpm", &data->img_width, &data->img_height);
